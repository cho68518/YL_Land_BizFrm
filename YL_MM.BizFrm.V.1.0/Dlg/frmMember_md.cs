...
{
    public partial class frmMember_md : FrmPopUpBase
    {
        ...
        private void frmMember_md_Load(object sender, EventArgs e)
        {
        ...
        private void Open1()
        {
            try
            {
                ...
                {
                    using (MySqlCommand cmd = new MySqlCommand("domabiz.USP_MM_MM19_POP01_SELECT_01", con))
                    {
        ...
        private void txtSearch_Name_KeyDown(object sender, KeyEventArgs e)
        {
