...
{
    public partial class frmGM09 : FrmBase
    {
        public frmGM09()
        {
            InitializeComponent();
            ...
            this.QCode = "GM09";
            //폼명설정
            this.FrmName = "MD별 체험샵 등록현황";
        }

        private void frmGM09_Load(object sender, EventArgs e)
        {
            base.FrmLoadEvent();
        ...
        public override void Search()
        {
            try
            {
                ...
                {
                    using (MySqlCommand cmd = new MySqlCommand("domabiz.USP_GM_GM09_SELECT_01", con))
                    {
        ...
        public void Open1()
        {
            try
            {
                ...
                {
                    using (MySqlCommand cmd = new MySqlCommand("domabiz.USP_GM_GM09_SELECT_02", con))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
