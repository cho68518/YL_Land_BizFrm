...
{
    public partial class frmGM11_Pop03 : FrmPopUpBase
    {
        public string to_day { get; set; }
        public frmGM11_Pop03()
        {
            InitializeComponent();
        }
        private void frmGM11_Pop03_Load(object sender, EventArgs e)
        {
        ...
        private void Open1()
        {
            try
            {
                ...
                {
                    using (MySqlCommand cmd = new MySqlCommand("domabiz.USP_GM11_POP03_SELECT_01", con))
                    {
